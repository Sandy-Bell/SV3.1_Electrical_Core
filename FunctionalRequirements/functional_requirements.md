...
2. Diagnostics
	- 3.1 Sensing
		...
		- 3.1.5 The device should receive data from the Jetson, including GPS position.
...
4. Physical Layout - Ezra, Sandy
	- 4.1. Modular design
		- 4.1.1. All parts shall be easy to access and remove
		- 4.1.1.1. Server rack like system - further research required?
		- 4.1.1.2. layered racked system - further research required?
		- 4.1.1.3. Seperate box system - like alex said?
		  	- 4.1.2. Subsystems shall be positioned such that their nature is visually distinguishable
			- 4.1.2.1. Subsystems shall be colour coded
			- 4.1.2.2. Subsystems shall be placed in positions that do not overlap and have clear seperation
			- 4.1.3. Internal components shall placed in positions that minimise interference and clutter
	- 4.2. Mechanical Security
		- 4.2.1. All ICs, cables and components shall remain connected and in place during a mission and transportation.
		- 4.2.2. Mechanical stresses induced by vibration, corrosion, heat etc. shall be minimised.
			- 4.2.2.1. Dampening systems shall be used where required to reduce stresses on securely connected pieces.
		- 4.2.3. Wiring connections shall be secure.
			- 4.2.3.1. Cables/wires which will not require disconnection for maintenance (and are not on a PCB) shall be soldered or otherwise fixed in place.
			- 4.2.3.2. Cables/wires which do require disconnection for maintenance shall use safe and reliable terminal connectors (screw terminals etc., NOT dupont or a breadboard :(. **Fuck dupont cables**).
	- 4.3. Wire Management
		- 4.3.1. Shorter signal paths shall be prioritised.
		- 4.3.2. Shielding shall be present over cable connections where possible.
		- 4.3.3. The wiring shall be self-documenting.
			- 4.3.3.1. All cables shall be colour coded with a standardised, well documented system
			- 4.3.3.2. Stickers/Labels shall be placed on key/large cables and on cables that are frequently disconnected for maintenance
		- 4.3.4. The wiring shall be organised in a manner which minimises interference
			- 4.3.4.1. High voltage cables (especially high frequency) shall be considerably positioned from information cables (maximally far, or shielded, or wrapped around ground etc.).
			- 4.3.4.2. Cables shall be arranged in forms that reduce parasitic capacitance/inductance and other forms of energy loss.
		- 4.3.4. The wiring shall not be cluttered.
			- 4.3.4.1. The wiring shall be organised, w good cable management.
			- 4.3.4.2. The wiring shall not interfere or coincide with any moving/potentially damaging parts (fans, hot parts etc.)
	- 4.4. Cooling
		- 4.4.1. Main box(es) shall maintain standard operating temperature (-4°C to 44°C)
		- 4.4.2. ESCs are able to maintain standard operating temperature (-4°C to 64°C)
			- 4.4.2.1. ESC Compartment shall be made of a reflective material
			- 4.4.2.2. Need to asses need or possibility for active cooling (passive heatsinks + active airflow)?
	- 4.4. Waterproofing
		- 4.4.1. All cable connections passing in/out of housing compartments shall have waterproof cables glands
